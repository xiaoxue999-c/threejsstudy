...
let displaceTexture = new THREE.TextureLoader().load(wl4)
let roughnessTexture = new THREE.TextureLoader().load(wl5)
let matelnessTexture = new THREE.TextureLoader().load(wl6)
let normalTexture = new THREE.TextureLoader().load(wl7)
// 创建材质
